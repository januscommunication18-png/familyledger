...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (Schema::hasTable('member_medical_info')) {
        ...
        if (Schema::hasTable('member_healthcare_providers')) {
        ...
        if (Schema::hasTable('member_allergies')) {
        ...
        if (Schema::hasTable('member_medications')) {
        ...
        if (Schema::hasTable('member_medical_conditions')) {
        ...
        // Person Emails table
        if (Schema::hasTable('person_emails')) {
