                        ...
                        <ul class="space-y-2">
                            @foreach($taxReturn->federal_returns as $index => $path)
                                <li class="flex items-center justify-between text-sm text-slate-700">
                                    ...
                                    <a href="{{ route('documents.tax-returns.download', [$taxReturn, 'federal', $index]) }}" class="btn btn-ghost btn-xs gap-1 text-blue-600 hover:bg-blue-100" title="Download">
                        ...
                        <ul class="space-y-2">
                            @foreach($taxReturn->state_returns as $index => $path)
                                <li class="flex items-center justify-between text-sm text-slate-700">
                                    ...
                                    <a href="{{ route('documents.tax-returns.download', [$taxReturn, 'state', $index]) }}" class="btn btn-ghost btn-xs gap-1 text-purple-600 hover:bg-purple-100" title="Download">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>
                                    </a>
                                </li>
                            @endforeach
                        ...
                        <ul class="space-y-2">
                            @foreach($taxReturn->supporting_documents as $index => $path)
                                <li class="flex items-center justify-between text-sm text-slate-700">
                                    ...
                                    <a href="{{ route('documents.tax-returns.download', [$taxReturn, 'supporting', $index]) }}" class="btn btn-ghost btn-xs gap-1 text-amber-600 hover:bg-amber-100" title="Download">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>
                                        Download
                                    </a>
                                </li>
