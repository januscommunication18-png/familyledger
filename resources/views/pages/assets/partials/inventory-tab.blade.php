...
<div class="flex justify-between items-center mb-6">
    <h2 class="text-lg font-semibold">Home Inventory</h2>
    <a href="{{ route('assets.create', ['category' => 'inventory']) }}" class="btn btn-primary btn-sm gap-2">
                ...
                <div class="flex items-start justify-between">
                    <div class="flex items-start gap-4">
                        <div class="w-12 h-12 rounded-lg bg-info/10 flex items-center justify-center flex-shrink-0">
                            <span class="icon-[tabler--box] size-6 text-info"></span>
                        </div>
                        <div>
                            ...
                            @if($asset->warranty_expiry)
                                <p class="text-sm {{ $asset->isWarrantyExpiringSoon() ? 'text-warning' : 'text-base-content/60' }} mt-1">
...
@else
    <div class="text-center py-12 text-base-content/60">
        <span class="icon-[tabler--box-off] size-16 opacity-30"></span>
        <p class="mt-4 text-lg font-medium">No inventory items</p>
        <p class="text-sm">Add your first home inventory item</p>
        <a href="{{ route('assets.create', ['category' => 'inventory']) }}" class="btn btn-primary mt-4">
            <span class="icon-[tabler--plus] size-4"></span>
            Add Item
        </a>
    </div>
