...
<div class="space-y-6">
    ...
    <div>
        ...
        @php
            ...
            $isOwner = $owner && $owner->id === auth()->user()->id;
            $onboardingSkipped = $tenant->onboarding_skipped ?? false;
        @endphp

        @if($isOwner && $onboardingSkipped)
        <!-- Onboarding Section (only for owners who skipped) -->
                ...
                <div class="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-amber-700 mt-1">You skipped the initial setup process. Complete it to get the most out of FamilyLedger and configure your family preferences.</p>
                        </div>
                    </div>
                </div>
