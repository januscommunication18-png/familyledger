...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #f9fafb; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 10px 10px;">
        ...
        <p>You are attempting to log in to the Family Ledger Backoffice. Use the security code below to complete your login:</p>

        <div style="background: white; border: 2px dashed #9333ea; border-radius: 10px; padding: 20px; text-align: center; margin: 25px 0;">
            <p style="margin: 0 0 10px 0; color: #6b7280; font-size: 14px;">Your Security Code</p>
        ...
        <p>If you did not attempt to log in, please ignore this email. Someone may have entered your email address by mistake.</p>
