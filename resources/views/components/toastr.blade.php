...
<div id="toastr-container" class="fixed top-4 right-4 z-[9999] flex flex-col gap-3 max-w-sm">
    ...
    <div class="toastr-notification toastr-success animate-slide-in" role="alert">
        <div class="flex items-start gap-3 p-4 rounded-lg bg-emerald-50 border border-emerald-200 shadow-lg">
            <div class="shrink-0 w-6 h-6 rounded-full bg-emerald-500 flex items-center justify-center">
            ...
            <button type="button" onclick="this.closest('.toastr-notification').remove()" class="shrink-0 text-emerald-400 hover:text-emerald-600">
    ...
    <div class="toastr-notification toastr-error animate-slide-in" role="alert">
        <div class="flex items-start gap-3 p-4 rounded-lg bg-rose-50 border border-rose-200 shadow-lg">
            <div class="shrink-0 w-6 h-6 rounded-full bg-rose-500 flex items-center justify-center">
            ...
            <button type="button" onclick="this.closest('.toastr-notification').remove()" class="shrink-0 text-rose-400 hover:text-rose-600">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
            </button>
        </div>
    </div>
    ...
    <div class="toastr-notification toastr-warning animate-slide-in" role="alert">
        <div class="flex items-start gap-3 p-4 rounded-lg bg-amber-50 border border-amber-200 shadow-lg">
            <div class="shrink-0 w-6 h-6 rounded-full bg-amber-500 flex items-center justify-center">
            ...
            <button type="button" onclick="this.closest('.toastr-notification').remove()" class="shrink-0 text-amber-400 hover:text-amber-600">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
            </button>
        </div>
    </div>
    ...
    <div class="toastr-notification toastr-info animate-slide-in" role="alert">
        <div class="flex items-start gap-3 p-4 rounded-lg bg-blue-50 border border-blue-200 shadow-lg">
            ...
            <div class="flex-1">
                ...
                <p class="text-sm text-blue-700 mt-0.5">{{ session('info') }}</p>
            </div>
            <button type="button" onclick="this.closest('.toastr-notification').remove()" class="shrink-0 text-blue-400 hover:text-blue-600">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
            </button>
        </div>
    </div>
