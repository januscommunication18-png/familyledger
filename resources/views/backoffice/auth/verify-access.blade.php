...
@section('content')
    <div>
        <div class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Verify Access</h2>
        ...
        <form method="POST" action="{{ route('backoffice.verify-access.submit') }}" class="space-y-6" id="verifyForm">
            @csrf
        ...
        <div class="mt-6 text-center">
            ...
            <form method="POST" action="{{ route('backoffice.resend-access-code') }}" class="inline">
                @csrf
