    ...
    <div x-data="{ showResetModal: false, resetConfirmText: '' }">
            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-red-700 dark:text-red-400 mt-1">
                        This action will permanently delete ALL data including users and tenants. This cannot be undone.
                        Only backoffice admin accounts and system configurations will remain.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 mb-6">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    <h4 class="font-medium text-green-600 dark:text-green-400 mb-2">Will Be Kept (Admin Only):</h4>
                    <ul class="space-y-1 text-sm text-gray-600 dark:text-gray-400">
                        <li class="flex items-center gap-2">
                ...
                >
                    ...
                    <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 mb-4">
                        <p class="text-sm text-red-800 dark:text-red-300">
                            <strong>Warning:</strong> This will permanently delete ALL data including users and tenants. Only backoffice admins and system config will remain. This action cannot be undone.
                        </p>
                    </div>
