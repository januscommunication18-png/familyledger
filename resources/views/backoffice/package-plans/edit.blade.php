...
@section('content')
    <div class="max-w-4xl">
        ...
        <form method="POST" action="{{ route('backoffice.package-plans.update', $packagePlan) }}" class="space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            id="name"
                            name="name"
                            value="{{ old('name', $packagePlan->name) }}"
                    ...
                    <div>
                        ...
                        <select
                            ...
                            required
                        >
                            <option value="free" {{ old('type', $packagePlan->type) === 'free' ? 'selected' : '' }}>Free Plan</option>
                            <option value="paid" {{ old('type', $packagePlan->type) === 'paid' ? 'selected' : '' }}>Paid Plan</option>
                        </select>
                        @error('type')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea
                            ...
                            rows="3"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
                        >{{ old('description', $packagePlan->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('trial_period_days', $packagePlan->trial_period_days) }}"
                            min="0"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
                            required
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="cost_per_month"
                            name="cost_per_month"
                            value="{{ old('cost_per_month', $packagePlan->cost_per_month) }}"
                            min="0"
                            step="0.01"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
                            required
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="cost_per_year"
                            name="cost_per_year"
                            value="{{ old('cost_per_year', $packagePlan->cost_per_year) }}"
                            min="0"
                            step="0.01"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
                            required
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('family_circles_limit', $packagePlan->family_circles_limit) }}"
                            min="0"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
                            required
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('family_members_limit', $packagePlan->family_members_limit) }}"
                            min="0"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
                            required
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('document_storage_limit', $packagePlan->document_storage_limit) }}"
                            min="0"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
                            required
                        >
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                ...
                @php
                    $selectedFeatures = old('reminder_features', $packagePlan->reminder_features ?? []);
                @endphp
                ...
                <div class="space-y-3">
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input
                            ...
                            {{ in_array('push_notification', $selectedFeatures) ? 'checked' : '' }}
                    ...
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input
                            ...
                            {{ in_array('email_reminder', $selectedFeatures) ? 'checked' : '' }}
                            class="w-5 h-5 text-primary-600 border-gray-300 rounded focus:ring-primary-500"
                        >
                    ...
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input
                            ...
                            name="reminder_features[]"
                            value="sms_reminder"
                            {{ in_array('sms_reminder', $selectedFeatures) ? 'checked' : '' }}
                            class="w-5 h-5 text-primary-600 border-gray-300 rounded focus:ring-primary-500"
                        >
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('paddle_product_id', $packagePlan->paddle_product_id) }}"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('paddle_monthly_price_id', $packagePlan->paddle_monthly_price_id) }}"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('paddle_yearly_price_id', $packagePlan->paddle_yearly_price_id) }}"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
                        >
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input
                                ...
                                name="is_active"
                                value="1"
                                {{ old('is_active', $packagePlan->is_active) ? 'checked' : '' }}
                                class="w-5 h-5 text-primary-600 border-gray-300 rounded focus:ring-primary-500"
                            >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="sort_order"
                            name="sort_order"
                            value="{{ old('sort_order', $packagePlan->sort_order) }}"
                            min="0"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
                        >
                        @error('sort_order')
