...
@section('title', ($document ? 'Edit' : 'Add') . ' Social Security Card')
@section('page-name', ($document ? 'Edit' : 'Add') . ' Social Security Card')
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-slate-900">{{ $document ? 'Edit' : 'Add' }} Social Security Card</h1>
