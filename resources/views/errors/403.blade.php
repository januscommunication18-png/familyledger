...
<head>
    ...
    <title>Access Denied - Family Hub</title>
...
<body class="bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full text-center">
        <!-- Icon -->
        <div class="mb-8">
            <div class="w-24 h-24 mx-auto bg-gradient-to-br from-rose-400 to-red-500 rounded-full flex items-center justify-center shadow-lg shadow-rose-500/30">
        ...
        <!-- Content -->
        <h1 class="text-3xl font-bold text-slate-800 mb-4">Access Denied</h1>
